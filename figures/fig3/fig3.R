...
#### LOAD DATA ####
load("../results/summarized.scalar.outputs.RData")
...
#save
ggsave(scalar.state,
       filename = paste0("../figures/fig3/fig3.pdf"),
       width = 14,
       height = 7,
       units = "in")
ggsave(scalar.state,
       filename = paste0("../figures/fig3/fig3.jpg"),
       width = 14,
       height = 7,
       units = "in")
ggsave(scalar.state,
       filename = paste0("./figures/fig3/fig3.png"),
       width = 14,
       height = 7,
       units = "in")
